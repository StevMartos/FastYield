...
# -------------------------------------------------------------------------
# Valid molecular templates
# -------------------------------------------------------------------------

mol_list = ["H2O", "CO2", "O3", "N2O", "CO", "CH4", "O2", "NO", "SO2", "NO2", "NH3"]
...
extra_bands = {
    ...
    # ------------------------------------------------------------------
    # Standard broad photometric bands
    ...
    # ------------------------------------------------------------------
    # JWST / NIRCam-like bands
    # ------------------------------------------------------------------
    "F150W": (1.3313, 1.6689),
    "F480M": (4.5820, 5.0919),

    # ------------------------------------------------------------------
    # JWST / MIRI Imaging filters
    # ------------------------------------------------------------------
    "F560W":  (4.860,  6.430),
    "F770W":  (6.620,  8.740),
    "F1000W": (8.570,  11.300),
    "F1130W": (10.950, 12.660),
    "F1280W": (11.520, 14.050),
    "F1500W": (13.290, 16.840),
    "F1800W": (16.240, 20.050),
    "F2100W": (18.550, 24.500),
    "F2550W": (22.470, 29.890),

    # ------------------------------------------------------------------
    # JWST / MIRI Coronagraphic filters
    # ------------------------------------------------------------------
    "F1065C": (10.000, 11.000),
